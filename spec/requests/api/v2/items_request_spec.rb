...
describe "Items API" do 
  ...
  it 'sends 10 items from page 3 by default' do 
    merchant1 = create(:merchant)
    create_list(:item,20, merchant_id: merchant1.id)
    merchant2 = create(:merchant)
    create_list(:item,20, merchant_id: merchant2.id)

    get "/api/v2/items?page=3&per_page=10", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'sends one item' do 
    ...
    get "/api/v2/items/#{item.id}", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'creates a new item and ignores extra attributes' do 
    ...
    headers = {"CONTENT_TYPE" => "application/json",'Authorization'=> 'Bearer abc'}

    post "/api/v2/items", headers: headers, params: JSON.generate(item: item_params)
  ...
  it 'updates an existing item' do 
    ...
    patch "/api/v2/items/#{item.id}", headers: headers, params: JSON.generate(item: item_params)
  ...
  it 'cannot update item with bad merchant_id' do 
    ...
    patch "/api/v2/items/#{original_item.id}", headers: headers, params: JSON.generate(item: item_params)
  ...
  it 'destroys an item' do 
    ...
    delete "/api/v2/items/#{item.id}", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'sends merchant info that an item belongs to' do 
    ...
    get "/api/v2/items/#{item.id}/merchant", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'finds all items by partial name match' do 
    ...
    get "/api/v2/items/find_all?name=ring", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'finds all items by min_price search' do 
    ...
    get "/api/v2/items/find_all?min_price=25", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'finds all items by min_price search' do 
    ...
    get "/api/v2/items/find_all?max_price=50", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'finds all items by min and max_price search' do 
    ...
    get "/api/v2/items/find_all?min_price=10&max_price=50", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'returns empty array when no merchant(alphabetical)(find_all) by partial match' do 
    ...
    get "/api/v2/items/find_all?name=ringggg", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'finds and sends first item(alphabetical) by partial name match' do 
    ...
    get "/api/v2/items/find?name=ring", headers: {'Authorization'=> 'Bearer abc'}
  ...
  it 'returns error when no item(alphabetical)(find) by partial name match' do 
    ...
    get "/api/v2/items/find?name=ringgg", headers: {'Authorization'=> 'Bearer abc'}
    item_found = JSON.parse(response.body, symbolize_names: true)[:data]
    expect(response).to be_successful
  ...
  it 'finds and sends first item(alphabetical) by min price search' do 
    ...
    get "/api/v2/items/find?min_price=40", headers: {'Authorization'=> 'Bearer abc'}
    item_found = JSON.parse(response.body, symbolize_names: true)[:data]
    expect(response).to be_successful
  ...
  it 'finds and sends first item(alphabetical) by max price search' do 
    ...
    get "/api/v2/items/find?max_price=40", headers: {'Authorization'=> 'Bearer abc'}
    item_found = JSON.parse(response.body, symbolize_names: true)[:data]
    expect(response).to be_successful
  ...
  it 'finds and sends first item(alphabetical) by max and min price search' do 
    ...
    get "/api/v2/items/find?max_price=40&min_price=10", headers: {'Authorization'=> 'Bearer abc'}
    item_found = JSON.parse(response.body, symbolize_names: true)[:data]
    expect(response).to be_successful
  ...
  describe 'edge cases' do 
    ...
    it 'handles edge case with no params when finding one item' do 
      get "/api/v2/items/find", headers: {'Authorization'=> 'Bearer abc'}
      item_found = JSON.parse(response.body, symbolize_names: true)[:data]
    ...
    it 'handles edge case with empty params when finding one merchant' do 
      ...
      get "/api/v2/items/find?name=", headers: {'Authorization'=> 'Bearer abc'}
    ...
    it 'handles edge case with no params when finding items' do 
      ...
      get "/api/v2/items/find_all", headers: {'Authorization'=> 'Bearer abc'}
      item_found = JSON.parse(response.body, symbolize_names: true)[:data]
    ...
    it 'handles edge case with empty params when finding items' do 
      ...
      get "/api/v2/items/find_all?name=", headers: {'Authorization'=> 'Bearer abc'}
    ...
    it 'handles edge case when max_price is less than min price' do 
      ...
      get "/api/v2/items/find?max_price=50&min_price=100", headers: {'Authorization'=> 'Bearer abc'}
    ...
    it 'handles edge case where max_price cannot be negative' do 
      get "/api/v2/items/find?max_price=-50", headers: {'Authorization'=> 'Bearer abc'}
